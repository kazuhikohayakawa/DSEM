...
proc_MG_real <- function (Y_TN, X_TN, Job_c, Home_c, Dep_b, ID, N ) {
  ...
  theta_gamma_MG_CI    <- cbind(theta_gamma_MG_coef    - 1.96*theta_gamma_MG_se,    theta_gamma_MG_coef    + 1.96*theta_gamma_MG_se)
  theta_gamma_JKMG_CI  <- cbind(theta_gamma_JKMG_coef  - 1.96*theta_gamma_JKMG_se,  theta_gamma_JKMG_coef  + 1.96*theta_gamma_JKMG_se)
  theta_gamma_BCMG1_CI <- cbind(theta_gamma_BCMG1_coef - 1.96*theta_gamma_BCMG1_se, theta_gamma_BCMG1_coef + 1.96*theta_gamma_BCMG1_se)
  theta_gamma_BCMG2_CI <- cbind(theta_gamma_BCMG2_coef - 1.96*theta_gamma_BCMG2_se, theta_gamma_BCMG2_coef + 1.96*theta_gamma_BCMG2_se)
  ...
  return(list(
    ...
    theta_gamma_MG_CI      = theta_gamma_MG_CI,
    theta_gamma_JKMG_coef  = theta_gamma_JKMG_coef,  
    theta_gamma_JKMG_CI    = theta_gamma_JKMG_CI,
    theta_gamma_BCMG1_coef = theta_gamma_BCMG1_coef, 
    theta_gamma_BCMG1_CI   = theta_gamma_BCMG1_CI, 
    theta_gamma_BCMG2_coef = theta_gamma_BCMG2_coef, 
    theta_gamma_BCMG2_CI   = theta_gamma_BCMG2_CI, 
    omega_MG       = omega_MG,
